					...
					[
						{
							...
							value: function getContexts() {
								...
								ctx.forEach((ctx2) => {
									var isDescendant = filteredCtx.filter((contexts) => contexts.contains(ctx2)).length > 0
						...
						},
						{
							...
							value: function getIframeContents(ifr, successFn) {
								var errorFn = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : () => {}
								var doc = void 0
								try {
						...
						},
						{
							...
							value: function forEachIframe(ctx, filter, each) {
								var end = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : () => {}
						...
						},
						{
							...
							value: function forEachNode(whatToShow, each, filter) {
								var _this6 = this
								var done = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : () => {}
					...
					},
					{
						...
						value: function checkRanges(array) {
							...
							array
								...
								.forEach((item) => {
									var _callNoMatchOnInvalid = this.callNoMatchOnInvalidRanges(item, last),
						...
						value: function wrapRangeFromIndex(ranges, filterCb, eachCb, endCb) {
							this.getTextNodes((dict) => {
								...
								ranges.forEach((range, counter) => {
									var _checkWhitespaceRange = this.checkWhitespaceRanges(range, originalLength, dict.value),
