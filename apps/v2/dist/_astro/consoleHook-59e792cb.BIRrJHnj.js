import { c as h, i as M } from './SandpackSnippet.DQkj9R0A.js'
var k = (() => {
	function t() {
		;(this.listeners = {}),
	...
	return (
		...
		(t.prototype.dispatch = function (r) {
			Object.values(this.listeners).forEach((e) => e(r))
		}),
...
var A = (t) => (typeof t == 'string' ? new TextEncoder().encode(t) : t),
	C = (t) => (typeof t == 'string' ? t : new TextDecoder().decode(t)),
	D = (t) =>
		Object.entries(t).reduce((r, e) => {
			var s = e[0],
				f = e[1]
...
`
export { A as w, C as r, D as a, I as f, k as E, N as g, P as c, z as b }
