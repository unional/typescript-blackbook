import { S as D } from './base-80a1f760.EHupSAwf.js'
import { a as $, E as H, b as N, c as W } from './consoleHook-59e792cb.BIRrJHnj.js'
import { a as A, b as L, _ as R } from './SandpackSnippet.DQkj9R0A.js'
var k, U
function B() {
	if (U) return k
	U = 1
	var u = Object.create,
		...
		s = (a, e) => () => (e || (0, a[n(a)[0]])((e = { exports: {} }).exports, e), e.exports),
		x = (a, e) => {
		...
		b = (a, e, c, r) => {
			if ((e && typeof e == 'object') || typeof e == 'function')
				for (const t of n(e))
					!l.call(a, t) && t !== c && p(a, t, { get: () => e[t], enumerable: !(r = i(e, t)) || r.enumerable })
			return a
		},
		m = (a, e, c) => (
			(c = a != null ? u(o(a)) : {}), b(!a || !a.__esModule ? p(c, 'default', { value: a, enumerable: !0 }) : c, a)
		),
		...
		j = {}
	x(j, { PreviewController: () => O, getExtension: () => _, joinFilepath: () => q, normalizeFilepath: () => w }),
		(k = h(j))
	var g = '$CSB_RELAY',
		S = m(P()),
		z = new Map(),
	...
	var O = class {
		...
		async handleWorkerRequest(a) {
			...
			try {
				...
				if (
					(t == null && ((t = await this.getIndexAtPath(r)), (v['Content-Type'] = 'text/html; charset=utf-8')),
					t == null)
				)
				...
				const y = { $channel: g, $type: 'preview/response', id: a.id, headers: v, status: 200, body: t }
				c.postMessage(y)
			} catch {
				const t = {
					$channel: g,
		...
		async _initPreview() {
			...
			r.setAttribute('src', c.toString()), (r.style.display = 'none'), document.body.appendChild(r)
...
`.concat(o)
	...
	V = ((u) => {
		...
		function p(i, n, o) {
			o === void 0 && (o = {})
			var l,
				s = u.call(this, i, n, o) || this
			if (
				((s.files = new Map()),
				(s.status = 'initializing'),
				(s.emitter = new H()),
				(s.previewController = new J.PreviewController({
					baseUrl:
						(l = o.bundlerURL) !== null && l !== void 0 ? l : 'https://preview.sandpack-static-server.codesandbox.io',
					getFileContent: (b) => {
						var m = s.files.get(b)
						...
						if (b.endsWith('.html') || b.endsWith('.htm'))
							try {
								;(m = X(m)),
									(m = s.injectProtocolScript(m)),
									(m = s.injectExternalResources(m, o.externalResources)),
									(m = s.injectScriptIntoHead(m, { script: W, scope: { channelId: N() } }))
							} catch (h) {
			...
			return (
				...
				(s.eventListener = s.eventListener.bind(s)),
				typeof window < 'u' && window.addEventListener('message', s.eventListener),
				s.updateSandbox(),
				s
			)
		}
		return (
			(p.prototype.injectContentIntoHead = (i, n) => {
				var o
				return (
					(i = F(i)),
					(i =
...
`)
    ...
    `,
			...
			(p.prototype.updateSandbox = function (i, n) {
				...
				var o = $(i.files)
				this.dispatch({ codesandbox: !0, modules: o, template: i.template, type: 'compile' })
			}),
